...
var5 proves (from var4) that
increasing the number of layers to 5
while maintaining higher unit counts in
previous layers does NOT improve the accuracy
to more than 53%

in fact this is lower than var2 which only increased
units in the 2 layers

at the time of writing var5 I had no real knowledge
of measuring the impact to test data to tell if we
were overfitting
...
x = Dense(units=450, activation = 'relu')(x)
x = Dense(units=200, activation = 'relu')(x)
x = Dense(units=150, activation = 'relu')(x)
x = Dense(units=95,  activation = 'relu')(x)
