...
1. (200 -> 600 in layer 1)
2. (150 -> 450 in layer 2)
3. everything else is the same

result: max accuracy is 54% now (only 1% improvement var1.log)

also I don't really see how to quantify the impact on test data
yet so too early to say if I am overfitting the model already.
