...
Results : similar, as the overall accuracy does not improve
beyond 75% and the accuracy jumps after the 3/4th epoch are lower
...
print("\nCompiling the model (opt=Adam, loss=cat_cross-entropy, learning_rate=0.0005)\n")
